          ...
          <div className="flex justify-between items-center gap-3 sm:gap-4">
            <div className="flex items-center gap-2 flex-shrink-0 min-w-0">
              ...
              <div className="hidden md:block">
                <span className="text-sm font-bold bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent truncate">
                  Reborn Wave Group
                </span>
              </div>
            </div>
            <div className="flex items-center gap-1 sm:gap-3 flex-shrink-0">
              ...
              <Button 
                onClick={handleLogin} 
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 border-0 text-white px-2.5 sm:px-5 py-1.5 sm:py-2 rounded-full font-semibold text-xs sm:text-sm shadow-lg hover:shadow-purple-500/30 transition-all duration-300 transform hover:scale-105 hover:-translate-y-0.5 whitespace-nowrap"
              >
                <Zap className="w-3 h-3 sm:w-4 sm:h-4 inline sm:mr-1.5 mr-0.5" />
