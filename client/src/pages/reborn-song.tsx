...
function TopList() {
  ...
  return (
    <div>
      ...
      {search && <p className="mb-3 text-xs text-white/40">{isFetching ? "Searching song names, singers, Chinese and pinyin…" : searchResult?.spotifyConnected ? "Reborn + Apple + MusicBrainz + Spotify results" : "Reborn + free Apple and MusicBrainz results"}</p>}
