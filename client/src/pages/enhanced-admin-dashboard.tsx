            ...
            <Card className="bg-white/10 backdrop-blur border-white/20">
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-10 gap-4">
                    ...
                    >
                      <div className="text-center space-y-2">
                        ...
                        <div className="flex justify-center">
                          <Badge className={`text-xs ${user.role === 'admin' ? 'bg-red-500' : 'bg-blue-500'}`}>
                            {user.role || 'user'}
                          </Badge>
                        </div>
                        ...
                        <div className="flex justify-center gap-1">
                          ...
                          <Button
                            ...
                            className="bg-yellow-600 hover:bg-yellow-700 h-6 w-6 p-0"
                          >
                  ...
                  {/* Fill empty grid cells if less than 100 users */}
                  {Array.from({ length: Math.max(0, 100 - filteredUsers.length) }).map((_, index) => (
                    <div 
                      key={`empty-${index}`}
                      className="bg-white/5 border border-white/10 rounded-lg p-3 flex items-center justify-center"
                    >
                ...
                {filteredUsers.length > 100 && (
                  <div className="flex justify-center mt-6">
                    <div className="text-gray-300 text-sm">
                      Showing first 100 users of {filteredUsers.length} total
                    </div>
                  </div>
                )}
                
                {/* Legacy table view for detailed editing */}
                <div className="mt-8">
                  <h3 className="text-white text-lg font-semibold mb-4">Detailed User Management</h3>
