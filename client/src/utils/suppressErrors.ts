console.log('Error suppression loaded (WebSocket enabled)');
...
// WebSocket blocking disabled to enable real-time payment approval updates
...
window.onerror = function(message, source, lineno, colno, error) {
  ...
  // Suppress development-related errors but allow WebSocket connections
  if (messageStr.includes('syntaxerror') ||
...
console.error = function(...args: any[]) {
  ...
  if (message.includes('client.536') ||
