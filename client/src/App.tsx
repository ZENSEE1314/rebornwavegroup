...
import EnhancedAdminDashboardV2 from "@/pages/enhanced-admin-dashboard-v2";
    ...
    <Switch>
      ...
      {!isAuthenticated ? (
        ...
        <>
          ...
          <Route path="/admin" component={EnhancedAdminDashboardV2} />
          <Route path="/admin-dashboard" component={EnhancedAdminDashboardV2} />
