...
import CompleteAdminDashboard from "@/pages/admin-dashboard-complete";
    ...
    <Switch>
      ...
      {!isAuthenticated ? (
        ...
        <>
          ...
          <Route path="/admin" component={CompleteAdminDashboard} />
          <Route path="/admin-dashboard" component={CompleteAdminDashboard} />
