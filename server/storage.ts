...
export interface IStorage {
  ...
  updateUserProfile(id: string, profile: { firstName?: string; lastName?: string; username?: string; phoneNumber?: string; gender?: string; dateOfBirth?: Date; profileImageUrl?: string }): Promise<void>;
...
export class DatabaseStorage implements IStorage {
  ...
  async updateUserProfile(id: string, profile: { firstName?: string; lastName?: string; username?: string; phoneNumber?: string; email?: string; role?: string; gender?: string; dateOfBirth?: Date; profileImageUrl?: string }): Promise<void> {
    await db
      .update(users)
      .set({
        ...profile,
  ...
  // Helper function to calculate voter tier based on stars given (same as individual ranking requirements)
